...
class SharedForestService:
    ...
    def create_leaf(self, payload: dict[str, Any], app_user: dict[str, Any]) -> dict[str, Any]:
        ...
        owner_nickname = self._normalize_optional_text(app_user.get("nickname"), MAX_OWNER_NICKNAME_LENGTH)
